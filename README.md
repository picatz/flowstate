...
| **Extend** | Typed out-of-process tasks and secret providers over ConnectRPC; Git, GitHub, OCI, SCIM, Slack, SQL, VCS, and bounded Codex plugins; curated Go embedding API | [Plugins](docs/PLUGINS.md) · [Embedding](docs/EMBEDDING.md) |

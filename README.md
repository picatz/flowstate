...
| **Extend** | Typed out-of-process tasks and secret providers over ConnectRPC; Docker, Git, GitHub, OCI, SCIM, Slack, SQL, SSH, VCS, and bounded Codex plugins; curated Go embedding API | [Plugins](docs/PLUGINS.md) · [Embedding](docs/EMBEDDING.md) |

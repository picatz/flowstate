...
|---|---|---|
| **Control flow** | `if:`, `retry:` with backoff, `continue_on_error:`, `for_each`/`parallel:` fan-out, and `call:` to run another Flowfile as an isolated step | [DSL.md](docs/DSL.md) · [conditional-and-retry](examples/conditional-and-retry) · [fan-out-and-parallel](examples/fan-out-and-parallel) · [call-a-workflow](examples/call-a-workflow) |
...
| **Examples** | Fifty worked Flowfiles, indexed by what each one demonstrates | [examples/README.md](examples/README.md) |

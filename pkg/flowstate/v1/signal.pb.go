...
// ARCHITECTURE.md invariant 1 (proto-first) exists to prevent.
//
...
type SignalSender struct {
	...
	// header, and this value is written into durable run state, where

...
//
// The two tests below are the two halves of the fix, and the second is the one
// that keeps it honest: a map's entry order stops being a difference, and a
// list's order does not.

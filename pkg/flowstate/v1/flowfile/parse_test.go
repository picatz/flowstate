...
`,
			line: 5, col: 5,
			want: `unknown key "nonsense"; the keys here are id, description, if, vars, timeout, retry, continue_on_error, undo, with, digest, for_each, loop, parallel, sleep, wait_until, wait_for_signal, call, value, switch, http, and log`,
		},
		{

...
type Task_HTTP_Inputs struct {
	...
	// permanently, and repeat-safe 3xx and 5xx responses are retried. This expression
	...
	//
	// The same rule applies to 3xx and 5xx responses: neither a redirect nor
	// even an origin's 500 can establish whether the mutation committed.

...
// TestAVarHoldingANestedExpressionEvaluates is #1200's language boundary: YAML
// owns the map shape and the fence computes only its leaf.
func TestAVarHoldingANestedExpressionEvaluates(t *testing.T) {
	t.Parallel()

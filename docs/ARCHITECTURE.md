...
HTTP is the first producer. A 3xx or 5xx response cannot prove whether a
non-idempotent operation took effect, so POST and PATCH stop as `UpstreamUnknown` unless

...
- Open a pull request without auto-merge. After the final push, obtain at least
  ...
  Codex and Copilot at most once each on the intended final head. Their
  availability is optional, but feedback that arrives before merge must be read
  and dispositioned; quota or absence is neither a defect nor approval.

...
Copilot are requested at most once each on the intended final head. Do not wait
or retry on quota or absence, but read and visibly classify every substantive
suggestion that arrives before merge; provider unavailability is neither a
project defect nor approval and does not replace provider-neutral evidence.
